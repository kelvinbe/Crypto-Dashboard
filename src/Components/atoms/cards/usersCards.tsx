...
return (
    ...
    >
      <Flex direction="column" alignItems="center">
        ...
        <span style={{backgroundColor: '#0075FF', width: 20, height: 20, display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: 5}}>
        {icon}
        </span>
        <Text marginLeft={2} color={'white'}  fontSize="xs">{title}</Text>
        </Flex>
        <Box>
